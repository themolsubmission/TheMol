...
task_metainfo = {
    ...
    # TDC ADMET Regression Datasets (normalization stats from preprocessing_stats.json)
    "aqsol": {"mean": -2.673769784037133, "std": 2.2663487078389197, "target_name": "aqsol"},
    "caco2": {"mean": -5.188736990083799, "std": 0.7603318788142848, "target_name": "caco2"},
    "cl-hepa": {"mean": 43.383412371134014, "std": 50.261021748684165, "target_name": "cl-hepa"},
    "cl-micro": {"mean": 21.76453846153846, "std": 24.750889943436587, "target_name": "cl-micro"},
    "half-life": {"mean": 5.3116924778761065, "std": 5.326466898841735, "target_name": "half-life"},
    "LD50": {"mean": 2.398819308659218, "std": 0.80271193989314, "target_name": "LD50"},
    "lipo": {"mean": 2.1645332136445243, "std": 1.1802909983381278, "target_name": "lipo"},
    "ppbr": {"mean": 91.74714785214786, "std": 9.521552753636227, "target_name": "ppbr"},
    "vdss": {"mean": 1.4162516212710765, "std": 1.563368219870815, "target_name": "vdss"},
}
...
class UniMolFinetuneTask(UnicoreTask):
    ...
    def load_dataset(self, split, **kwargs):
        ...
        remove_h_dataset = RemoveHydrogenDataset(
            dataset,
            "atoms",
            "coordinates",
        ...
        # Print truncation statistics for this split
        remove_h_dataset.print_truncation_stats(split_name=split.upper())
