    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        def one_dataset(raw_dataset, coord_seed, mask_seed):
            ...
            expand_dataset = MaskPointsDataset(
                ...
                random_token_prob=self.args.random_token_prob * 20,
            ...
            # encoder_token_dataset = token_dataset
            # encoder_coord_dataset = coord_dataset
            # encoder_target_dataset = token_dataset
            edge_dataset = PrependAndAppend(
            ...
            """At Generative Stage"""
            if self.args.task_sub == "generative":
                edge_type = EdgeTypeDataset(edge_dataset, len(self.dictionary))
            else: 
                """At Autoencoder Stage""" 
